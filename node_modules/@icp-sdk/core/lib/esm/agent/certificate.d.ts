 ...
 */
export declare function check_canister_ranges(params: CheckCanisterRangesParams): boolean;
/**
 ...
 */
export declare function lookupCanisterRanges(params: CheckCanisterRangesParams): Uint8Array;
/**
 ...
 * @see https://internetcomputer.org/docs/references/ic-interface-spec#http-read-state
 */
export declare function lookupCanisterRangesFallback(subnetId: Principal, tree: HashTree): Uint8Array;
/**
 ...
 */
export declare function decodeCanisterRanges(lookupValue: Uint8Array): CanisterRanges;
/**
 ...
 */
export declare function getSubnetIdFromCertificate(certificate: Cert, rootKey: Uint8Array): Principal;
export {};
