import type { JsonObject } from '../../../candid/index.js';
import { Principal } from '../../../principal/index.js';
import { type Identity } from '../../auth.ts';
import { type Agent, type ApiQueryResponse, type UpdateResult, type QueryFields, type ReadStateOptions, type ReadStateResponse, type SubmitResponse, type CallOptions } from '../api.ts';
...
export declare class HttpAgent implements Agent {
     ...
     */
    update(canisterId: Principal | string, fields: CallOptions, pollingOptions?: PollingOptions): Promise<UpdateResult>;
     ...
     */
    readSubnetState(subnetId: Principal | string, options: ReadStateOptions): Promise<ReadStateResponse>;
    ...
    fetchSubnetKeys(canisterId: Principal | string): Promise<SubnetNodeKeys>;
    /**
     ...
     */
    getSubnetIdFromCanister(canisterId: Principal | string): Promise<Principal>;
