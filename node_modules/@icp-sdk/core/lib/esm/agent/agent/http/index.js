...
import { HashTreeDecodeErrorCode, CreateHttpAgentErrorCode, MissingFetchErrorCode, ExcessiveSignaturesErrorCode, ExternalError, IdentityInvalidErrorCode, IngressExpiryInvalidErrorCode, InputError, LookupErrorCode, MalformedPublicKeyErrorCode, MalformedSignatureErrorCode, MissingRootKeyErrorCode, ProtocolError, QuerySignatureVerificationFailedErrorCode, RejectError, TimeoutWaitingForResponseErrorCode, TrustError, UncertifiedRejectUpdateErrorCode, UnexpectedErrorCode, UnexpectedV4StatusErrorCode, UnknownError, HttpErrorCode, HttpV4ApiNotSupportedErrorCode, TransportError, HttpFetchErrorCode, AgentError, MalformedLookupFoundValueErrorCode, CertificateOutdatedErrorCode, CertificateNotAuthorizedErrorCode, UNREACHABLE_ERROR, } from "../../errors.js";
import { AnonymousIdentity } from "../../auth.js";
import * as cbor from "../../cbor.js";
import { hashOfMap, requestIdOf } from "../../request_id.js";
import { QueryResponseStatus, isV4ResponseBody, isV2ResponseBody, } from "../api.js";
...
import { request as subnetStatusRequest } from "../../subnetStatus/index.js";
import { lookupNodeKeysFromCertificate } from "../../utils/readState.js";
import { Certificate, check_canister_ranges, getSubnetIdFromCertificate, lookup_path, lookupResultToBuffer, LookupPathStatus, } from "../../certificate.js";
import { readCertifiedReject } from "../../utils/certificateReject.js";
import { ed25519 } from '@noble/curves/ed25519';
import { createExpirableStore } from "../../utils/createExpirableStore.js";
...
import { RequestStatusResponseStatus } from "./types.js";
export { RequestStatusResponseStatus } from "./types.js";
...
export class HttpAgent {
    ...
    async #handleV4SyncResponse(body, response, requestId, effectiveCanisterId, methodName, httpDetails, requestDetails, pollingOptions) {
        ...
        switch (status) {
            ...
            default: {
                const errorCode = new UnexpectedV4StatusErrorCode(status, requestId, response, rawCertificate);
    ...
    async #doFetchSubnetKeys(effectiveCanisterId) {
        ...
        if (!canisterCertificate.cert.delegation) {
            ...
            if (!canisterInRange) {
                throw TrustError.fromCode(new CertificateNotAuthorizedErrorCode(effectiveCanisterId, subnetId));
            }
        }
