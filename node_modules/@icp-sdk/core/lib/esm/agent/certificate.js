...
import { CertificateHasTooManyDelegationsErrorCode, CertificateNotAuthorizedErrorCode, CertificateTimeErrorCode, CertificateVerificationErrorCode, DerKeyLengthMismatchErrorCode, DerPrefixMismatchErrorCode, ProtocolError, LookupErrorCode, TrustError, UnknownError, HashTreeDecodeErrorCode, UNREACHABLE_ERROR, MissingLookupValueErrorCode, UnexpectedErrorCode, CertificateNotAuthorizedForSubnetErrorCode, } from "./errors.js";
import { Principal } from '../principal/index.js';
import { compare as uint8Compare } from '../candid/index.js';
...
import { IC_STATE_ROOT_DOMAIN_SEPARATOR } from "./constants.js";
 ...
 */
export function lookupCanisterRanges(params) {
 ...
 * @see https://internetcomputer.org/docs/references/ic-interface-spec#http-read-state
 */
export function lookupCanisterRangesFallback(subnetId, tree) {
 ...
 */
export function decodeCanisterRanges(lookupValue) {
 ...
 */
export function getSubnetIdFromCertificate(certificate, rootKey) {
