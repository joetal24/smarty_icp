 ...
 */
class ECDSAKeyIdentity extends _agent_1.SignIdentity {
    /**
    ...
    static async generate(options) {
        ...
        const derKey = (0, _candid_1.uint8FromBufLike)(await effectiveCrypto.exportKey('spki', keyPair.publicKey));
    ...
    async sign(challenge) {
        ...
        const signature = (0, _candid_1.uint8FromBufLike)(await this._subtleCrypto.sign(params, this._keyPair.privateKey, challenge));
