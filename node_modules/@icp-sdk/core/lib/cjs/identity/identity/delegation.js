...
async function _createSingleDelegation(from, to, expiration, targets) {
    ...
    const challenge = new Uint8Array([
        ..._agent_1.IC_REQUEST_AUTH_DELEGATION_DOMAIN_SEPARATOR,
        ...new Uint8Array((0, _agent_1.requestIdOf)({ ...delegation })),
    ]);
            ...
            return {
                ...
                targets &&
                    targets.map((t) => {
                        ...
                        return _principal_1.Principal.fromHex(t);
                    })),
 ...
 */
class DelegationIdentity extends _agent_1.SignIdentity {
    /**
    ...
    async transformRequest(request) {
        ...
        const requestId = await (0, _agent_1.requestIdOf)(body);
        return {
            ...fields,
            body: {
                content: body,
                sender_sig: await this.sign(new Uint8Array([..._agent_1.IC_REQUEST_DOMAIN_SEPARATOR, ...new Uint8Array(requestId)])),
...
function isDelegationValid(chain, checks) {
    ...
    if (maybeScope) {
        if (Array.isArray(maybeScope)) {
            scopes.push(...maybeScope.map(s => (typeof s === 'string' ? _principal_1.Principal.fromText(s) : s)));
        }
        else {
            scopes.push(typeof maybeScope === 'string' ? _principal_1.Principal.fromText(maybeScope) : maybeScope);
        }
    }
