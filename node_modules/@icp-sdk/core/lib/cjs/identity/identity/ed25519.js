...
class Ed25519PublicKey {
    ...
    static from(maybeKey) {
        ...
        if (isObject(maybeKey)) {
            ...
            if (ArrayBuffer.isView(key)) {
                const view = key;
                return this.fromRaw((0, _candid_1.uint8FromBufLike)(view.buffer));
            }
            if (key instanceof ArrayBuffer) {
                return this.fromRaw((0, _candid_1.uint8FromBufLike)(key));
            }
    ...
    static derEncode(publicKey) {
        const key = (0, _agent_1.wrapDER)(publicKey, _agent_1.ED25519_OID);
        key.__derEncodedPublicKey__ = undefined;
        return key;
    }
    static derDecode(key) {
        const unwrapped = (0, _agent_1.unwrapDER)(key, _agent_1.ED25519_OID);
 ...
 */
class Ed25519KeyIdentity extends _agent_1.SignIdentity {
    /**
    ...
    static generate(seed) {
        ...
        if ((0, _candid_1.uint8Equals)(seed, new Uint8Array(new Array(32).fill(0)))) {
    ...
    static verify(sig, msg, pk) {
        const [signature, message, publicKey] = [sig, msg, pk].map(x => {
            ...
            return (0, _candid_1.uint8FromBufLike)(x);
        });
