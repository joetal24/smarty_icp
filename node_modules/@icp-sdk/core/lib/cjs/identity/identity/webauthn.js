...
const _agent_1 = require("../../agent/index.js");
const utils_1 = require("@noble/hashes/utils");
const _candid_1 = require("../../candid/index.js");
function _coseToDerEncodedBlob(cose) {
    return (0, _agent_1.wrapDER)(cose, _agent_1.DER_COSE_OID);
}
/**
...
async function _createCredential(credentialCreationOptions) {
    const defaultCredentialCreationOptions = {
        publicKey: {
    ...
    const creds = (await navigator.credentials.create(credentialCreationOptions ?? defaultCredentialCreationOptions));
    if (creds === null) {
        return null;
    }
    return {
 ...
 */
class WebAuthnIdentity extends _agent_1.SignIdentity {
    /**
    ...
    static async create(credentialCreationOptions) {
        ...
        const attObject = _agent_1.Cbor.decode(new Uint8Array(response.attestationObject));
        return new this((0, _candid_1.uint8FromBufLike)(creds.rawId), _authDataToCose(attObject.authData), creds.authenticatorAttachment ?? undefined);
    }
    ...
    async sign(blob) {
        ...
        const encoded = _agent_1.Cbor.encode({
