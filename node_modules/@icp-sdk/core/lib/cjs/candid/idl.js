 ...
 */
class CandidDecodeError extends Error {
    constructor(message) {
        super(message);
        this.name = 'CandidDecodeError';
        Object.setPrototypeOf(this, CandidDecodeError.prototype);
    }
}
exports.CandidDecodeError = CandidDecodeError;
var IDLTypeIds;
(function (IDLTypeIds) {
...
class TupleClass extends RecordClass {
    ...
    decodeValue(b, t) {
        ...
        if (tuple._components.length < this._components.length) {
            throw new CandidDecodeError(`Tuple mismatch: expected ${this._components.length} components, but received ${tuple._components.length}`);
        }
        const res = [];
...
function decodePrincipalId(b) {
    ...
    const len = Number((0, leb128_ts_1.lebDecode)(b));
    return _principal_1.Principal.fromUint8Array(new Uint8Array((0, leb128_ts_1.safeRead)(b, len)));
}
/**
...
function encode(argTypes, args) {
    ...
    return (0, buffer_ts_1.concat)(magicNumberBytes, table, len, typs, vals);
}
/**
