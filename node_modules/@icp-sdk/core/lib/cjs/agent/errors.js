...
exports.HttpV4ApiNotSupportedErrorCode = exports.HttpErrorCode = exports.HashTreeDecodeErrorCode = exports.UnexpectedV4StatusErrorCode = exports.UnexpectedErrorCode = exports.QuerySignatureVerificationFailedErrorCode = exports.MalformedPublicKeyErrorCode = exports.MissingSignatureErrorCode = exports.MalformedSignatureErrorCode = exports.ExcessiveSignaturesErrorCode = exports.CreateHttpAgentErrorCode = exports.MissingFetchErrorCode = exports.IngressExpiryInvalidErrorCode = exports.IdentityInvalidErrorCode = exports.HashValueErrorCode = exports.MissingRootKeyErrorCode = exports.RequestStatusDoneNoReplyErrorCode = exports.UncertifiedRejectUpdateErrorCode = exports.UncertifiedRejectErrorCode = exports.CertifiedRejectErrorCode = exports.CertificateOutdatedErrorCode = exports.TimeoutWaitingForResponseErrorCode = exports.HexDecodeErrorCode = exports.CborEncodeErrorCode = exports.CborDecodeErrorCode = exports.DerEncodeErrorCode = exports.DerDecodeErrorCode = exports.DerDecodeLengthMismatchErrorCode = exports.DerPrefixMismatchErrorCode = exports.DerKeyLengthMismatchErrorCode = exports.MissingLookupValueErrorCode = exports.MalformedLookupFoundValueErrorCode = exports.LookupErrorCode = exports.CertificateNotAuthorizedForSubnetErrorCode = exports.CertificateNotAuthorizedErrorCode = exports.CertificateHasTooManyDelegationsErrorCode = exports.CertificateTimeErrorCode = exports.CertificateVerificationErrorCode = exports.UnknownError = exports.InputError = exports.LimitError = exports.ExternalError = exports.TransportError = exports.RejectError = exports.ProtocolError = exports.TrustError = exports.AgentError = exports.ErrorCode = exports.ErrorVerbosity = exports.ErrorKindEnum = void 0;
exports.UNREACHABLE_ERROR = exports.EmptyCookieErrorCode = exports.MissingCookieErrorCode = exports.InvalidRootKeyErrorCode = exports.ExpiryJsonDeserializeErrorCode = exports.InvalidReadStateRequestErrorCode = exports.MissingCanisterIdErrorCode = exports.HttpFetchErrorCode = void 0;
 ...
 */
var ErrorVerbosity;
(function (ErrorVerbosity) {
    ErrorVerbosity["Normal"] = "normal";
    ErrorVerbosity["Verbose"] = "verbose";
})(ErrorVerbosity || (exports.ErrorVerbosity = ErrorVerbosity = {}));
const VERBOSE_ONLY_KEYS = new Set(['arg', 'certificate', 'nonce']);
function bytesReplacer(verbosity) {
    return (key, value) => {
        if (value instanceof Uint8Array) {
            ...
            return `hex(${value.length}):${(0, utils_1.bytesToHex)(value)}`;
        }
        return value;
    };
}
class ErrorCode {
    static { this.verbosity = ErrorVerbosity.Normal; }
...
exports.CertificateNotAuthorizedForSubnetErrorCode = CertificateNotAuthorizedForSubnetErrorCode;
...
exports.MissingFetchErrorCode = MissingFetchErrorCode;
...
class ExcessiveSignaturesErrorCode extends ErrorCode {
    constructor(signatureCount, maxExpected) {
        ...
        this.name = 'ExcessiveSignaturesErrorCode';
...
exports.ExcessiveSignaturesErrorCode = ExcessiveSignaturesErrorCode;
...
class UnexpectedV4StatusErrorCode extends ErrorCode {
    constructor(status, requestId, response, rawCertificate) {
        ...
        this.name = 'UnexpectedV4StatusErrorCode';
        Object.setPrototypeOf(this, UnexpectedV4StatusErrorCode.prototype);
    }
    toErrorMessage() {
        const replacer = (_k, v) => v instanceof Uint8Array ? `hex(${v.length}):${(0, utils_1.bytesToHex)(v)}` : v;
        return (`Unexpected request status in v4 sync response: "${this.status}"\n` +
            `  Request ID (hex): ${(0, utils_1.bytesToHex)(this.requestId)}\n` +
            `  Response: ${JSON.stringify(this.response, replacer, 2)}`);
    }
}
exports.UnexpectedV4StatusErrorCode = UnexpectedV4StatusErrorCode;
...
exports.HttpV4ApiNotSupportedErrorCode = HttpV4ApiNotSupportedErrorCode;
