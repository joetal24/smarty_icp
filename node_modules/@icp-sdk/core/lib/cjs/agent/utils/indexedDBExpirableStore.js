...
exports.IndexedDBExpirableStore = void 0;
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => {
                ...
                if (Date.now() - record.timestamp > this.expirationTime) {
                    ...
                    this.delete(key).then(() => resolve(undefined), () => resolve(undefined));
                    return;
                }
...
exports.IndexedDBExpirableStore = IndexedDBExpirableStore;
//# sourceMappingURL=indexedDBExpirableStore.js.map