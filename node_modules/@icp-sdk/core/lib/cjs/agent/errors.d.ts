import type { Principal } from '../principal/index.js';
import type { HttpDetailsResponse, NodeSignature, ReplicaRejectCode, SubmitResponse } from './agent/api.ts';
 ...
 */
export declare enum ErrorVerbosity {
    Normal = "normal",
    Verbose = "verbose"
}
export declare abstract class ErrorCode {
    readonly isCertified: boolean;
    static verbosity: ErrorVerbosity;
    requestContext?: RequestContext;
    callContext?: CallContext | PollingCallContext;
...
export declare class CertificateNotAuthorizedForSubnetErrorCode extends ErrorCode {
    readonly subnetId: Principal;
    name: string;
    constructor(subnetId: Principal);
    toErrorMessage(): string;
}
...
export declare class MissingFetchErrorCode extends ErrorCode {
    name: string;
    constructor();
    toErrorMessage(): string;
}
...
export declare class ExcessiveSignaturesErrorCode extends ErrorCode {
    readonly signatureCount: number;
    readonly maxExpected: number;
    name: string;
    constructor(signatureCount: number, maxExpected: number);
    toErrorMessage(): string;
}
...
export declare class UnexpectedV4StatusErrorCode extends ErrorCode {
    readonly status: string | undefined;
    readonly requestId: RequestId;
    readonly response: SubmitResponse['response'];
    readonly rawCertificate: Uint8Array;
    name: string;
    constructor(status: string | undefined, requestId: RequestId, response: SubmitResponse['response'], rawCertificate: Uint8Array);
    toErrorMessage(): string;
}
...
export declare class HttpV4ApiNotSupportedErrorCode extends ErrorCode {
    name: string;
    constructor();
    toErrorMessage(): string;
}
...
export declare class InvalidRootKeyErrorCode extends ErrorCode {
    readonly rootKey: Uint8Array;
    readonly expectedLength: number;
    name: string;
    constructor(rootKey: Uint8Array, expectedLength: number);
    toErrorMessage(): string;
}
export declare class MissingCookieErrorCode extends ErrorCode {
    readonly expectedCookieName: string;
    name: string;
    constructor(expectedCookieName: string);
    toErrorMessage(): string;
}
export declare class EmptyCookieErrorCode extends ErrorCode {
    readonly expectedCookieName: string;
    name: string;
    constructor(expectedCookieName: string);
    toErrorMessage(): string;
