...
import { type CreateCertificateOptions } from '../certificate.ts';
 ...
 */
export declare function pollForResponse(agent: Agent, canisterId: Principal, requestId: RequestId, options?: PollingOptions): Promise<PollForResponseResult>;
/**
