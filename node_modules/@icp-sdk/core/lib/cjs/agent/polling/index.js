...
const types_ts_2 = require("../agent/http/types.js");
...
async function pollForResponse(agent, canisterId, requestId, options = {}) {
    ...
    if (typeof maybeBuf === 'undefined') {
        ...
        status = types_ts_2.RequestStatusResponseStatus.Unknown;
    }
    else {
    ...
    switch (status) {
        ...
        case types_ts_2.RequestStatusResponseStatus.Received:
        case types_ts_2.RequestStatusResponseStatus.Unknown:
        case types_ts_2.RequestStatusResponseStatus.Processing: {
        ...
        case types_ts_2.RequestStatusResponseStatus.Rejected: {
            throw errors_ts_1.RejectError.fromCode((0, certificateReject_ts_1.readCertifiedReject)(cert, path, requestId));
        }
        case types_ts_2.RequestStatusResponseStatus.Done:
